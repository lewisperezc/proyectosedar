...
$gua_transaccion = $ins_transaccion->guaTransaccion(strtoupper($sigla_pago),$fecha,$nit_id,$cen_cos_id,$val_pag_nomina,$con_pago,$fecha,$num_quincena,$_SESSION['k_nit_id'],$fecha,$mes[1],$ano);
$cant_cuentas=0;
$a=0;

...
<title>Aportes Al Sistema De Pensi&oacute;n</title>
 ...
 function validar_vacios()
  {
		...
		if(form.mes.selectedIndex == 0){ CamposVacios += "* Mes\n"; form.mes.focus(); }
			...
			form.action = '../reportes_PDF/aportes_sistema_de_pension.php';
			form.submit();
  }
  </script>
</head>
...
<form name="aportes_sistema_de_salud" id="aportes_sistema_de_salud" method="post">
	<table border="2" bordercolor="#0099CC">
    	<tr>
        	<th colspan="4">Aportes Al Sistema De Pensi&oacute;n</th>
        </tr>
        <tr>

...
<form name="aux_tercero" id="aux_tercero" method="post">
 <center>
  <table>
   ...
   <tr><td colspan="4"><input type="button" value="PDF" onClick="abreFactura('estado_cuenta_vacaciones_2.php');"/>
   <input type="button" value="EXCEL" onClick="abreFactura('../reportes_EXCEL/estado_cuenta_vacaciones.php');"/></td></tr>
  </table>
 </center>
</form>
...
<form name="aux_tercero" id="aux_tercero" method="post">
 <center>
  <table>
   ...
   <tr><td colspan="4"><input type="button" value="PDF" onClick="abreFactura('../reportes_PDF/aux_fabs.php');"/>
   <!--<input type="button" value="EXCEL" onClick="abreFactura('../reportes_EXCEL/aux_fabs.php');"/>-->
   </td></tr>
  </table>
 </center>
</form>
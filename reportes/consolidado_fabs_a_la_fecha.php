...
?>
<form name="consolidado_fabs" id="consolidado_fabs" action="../reportes_EXCEL/consolidado_fabs_a_la_fecha.php" method="post">
<center>
    <table border="1" bordercolor="#0099CC">
        ...
        <th>DOCUMENTO INICIAL</th>
            ...
            <tr>
                <td><input type="text" name="doc_inicial" id="doc_inicial" list="doc_1" size="50" value="0" required>
                <datalist id="doc_1">
                <?php
                ...
                <td><input type="text" name="doc_final" id="doc_final" list="doc_2" size="50" value="9999999999" required>
                <datalist id="doc_2">
                <?php

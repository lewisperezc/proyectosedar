...
function Preguntar(mes,tipo,anio)
{
	...
	else
	{
		...
		$( "#dialog-confirm" ).dialog({
			...
			"PDF": function() {
			$( this ).dialog( "close" );
				AbreListadoFacturas('../reportes_PDF/listado_facturas_suma_jornadas.php?elmes='+mes+'&eltipo='+tipo+'&elanio='+anio);
			},
			"EXCEL": function() {
				//alert(anio);
				$( this ).dialog( "close" );
				AbreListadoFacturas('../reportes_EXCEL/listado_facturas_suma_jornadas.php?elmes='+mes+'&eltipo='+tipo+'&elanio='+anio);
			}
			}
			});
		});
...
<table border="2" bordercolor="#0099CC">
	<tr>
		<th colspan="4">Lisdato de facturas con jornadas</th>
	</tr>
	<tr>
		<th>Por mes</th>
		<th>General</th>

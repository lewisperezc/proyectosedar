...
?>
	<table border="1">
		...
		<tr>
            ...
            <th>Suma Jornadas</th>
			<th>Mes Servicio</th>
			<th>A&ntilde;n Servicio</th>
		</tr>
		<?php
		while($res_tod_datos=mssql_fetch_array($con_dat_factura))
		{
			$sum_rep_jor=$ins_rep_jornadas->canJorFac($res_tod_datos['fac_id']);
			//$sum_rep_jor_con_recibo=$ins_rep_jornadas->canJorFacConRecibo($res_tod_datos['fac_id']);
			$sum_rep_jor_con_recibo=0;
		...
		<tr>
			...
			<td><?php echo $res_tod_datos['fac_ano_servicio']; ?></td>
		</tr>
		<?php
		}
		?>

...
<title>Adiciones - <?php echo $_SESSION['cons']." - ".$_SESSION['nomb']; ?></title>
</head>
<body>
<?php
include_once('../clases/contrato.class.php');
$ins_contrato = new contrato();
$con_adi_contrato = $ins_contrato->con_adi_otr_contrato(1,$_SESSION['sele_contrato']);
?>
<form>
<center>
	<table border="1" bordercolor="#009999" width="100%">
    	<tr>
        	<th colspan="4">DATOS ADICIÓN</th>
            <tr>
            	<th>Fecha</th>
            	<th>Dinero</th>
                <th>N° Meses</th>
            ...
            <tr>
            	...
            	<td><?php echo $res_adi_contrato['adi_otr_valor']; ?></td>
            	<td><?php echo $res_adi_contrato['adi_otr_meses']; ?></td>

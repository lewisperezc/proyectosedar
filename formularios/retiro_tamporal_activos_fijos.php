...
$con_tod_mot_retiro=$ins_act_fijo->ConTodMotRetActFijo();
//LA FECHA//
...
////////////
?>
<form name="dar_baja_activo_fijo" id="dar_baja_activo_fijo" method="post" action="control/guardar_dar_baja_activo_fijo.php">
<center>
	<table>
    	<tr>
        	<th colspan="3">AUTORIZACIÒN PARA EL RETIRO TEMPORAL DE LAS OFICINAS DE SEDAR DE UN ACTIVO FIJO</th>
        </tr>
        <tr>
        	<th colspan="3"><?php echo $lafecha; ?></th>
        </tr>
        <tr>
        	<td>RESPONSABLE ACTUAL DEL ACTIVO QUE SE AUTORIZA SU RETIRO:</td>
        	<td>C.C: <input type="text" name="act_fij_res_actual" id="act_fij_res_actual" list="res_actual" size="15" onChange="DatosPersona(this.value,1,0);" pattern="[0-9]+" title="La cadena debe ser numerica" required/>
            ...
            <td>
            <input type="hidden" name="elidpersona" id="elidpersona"/>
            <input type="text" name="res_act_nombres" id="res_act_nombres" size="30" readonly required/>
            </td>
        </tr>
    </table>
    <table id="lositems">
    ...
    <table>
    	<tr>
        	<td>MOTIVO POR EL CUAL SE AUTORIZA EL RETIRO DEL ACTIVO FIJO RELACIONADO:</td>
            <td>
            <select>
            <option>Seleccione</option>
			<?php
            while($res_tod_mot_retiro=mssql_fetch_array($con_tod_mot_retiro))
			{
			?>
            <option value="<?php echo $res_tod_mot_retiro['mot_ret_act_fij_id']; ?>"><?php echo $res_tod_mot_retiro['mot_ret_act_fij_nombre']; ?></option>
            <?php
			}
			?>
            </select>
        ...
        <tr>
        	<th colspan="2">MOTIVO POR EL CUAL SE AUTORIZA EL RETIRO DEL ACTIVO FIJO RELACIONADO:</th>
        </tr>
        <tr>
        	<td colspan="2"><textarea name="mot_baja" id="mot_baja" cols="115" placeholder="Digite las observaciones aqui..." required></textarea></td>
        </tr>
        <tr>
        	<td colspan="2"><input type="submit" class="art-button" value="Asignar"/></td>
        </tr>
    </table>
</form>
</center>

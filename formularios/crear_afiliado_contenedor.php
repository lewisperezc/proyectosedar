...
<html>
    <head>
        ...
        function TipoSegSocial()
        {
        	if($("#tipo_descuento_seg_social").is(':checked'))
				$("#monto_fijo").css("display","block");
			else
				$("#monto_fijo").css("display","none");
        }
        </script>
    </head>
    <body>
             ...
             <div id='cont1'>
                <table>
                    ...
                    <tr>
                        ...
                        <td><input name="aso_pri_apellido" id="aso_pri_apellido" type="text" pattern="[A-Z��a-z ]+" required></td>
                        <td>Segundo Apellido</td>
                        <td><input name="aso_seg_apellido" id="aso_seg_apellido" type="text" pattern="[A-Z��a-z ]+" required/></td>
                    </tr>
                    <tr>
                        <td>Nombres</td>
                        <td><input name="aso_nombres" id="aso_nombres" type="text" pattern="[A-Z��a-z ]+" required/></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="aso_num_documento" id="aso_num_documento" onchange="ValidarDocumentoTercero(this.value,'aso_num_documento','btn1');" pattern="[0-9]+" required/></td>
                    ...
                    <tr>
                        ...
                        <td><input name="aso_por_pabs" id="aso_por_pabs" type="text" size="4" value="1" maxlength="2" required pattern="[0-9]+"/>%</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Fondo De Vacaciones</td><td>Si<input type="checkbox" checked name="aso_fon_vacaciones" id="aso_fon_vacaciones"/></td>
                        <td>Porcentaje</td><td><input readonly name="aso_por_fon_vacaciones" id="aso_por_fon_vacaciones" size="4" maxlength="2" type="text" value="4" required pattern="[0-9]+"/>%</td>
                    </tr>
                    <tr>
                        <td>Procedimiento</td>
                    ...
                    <tr>
                    	...
                    	<td><input readonly value="8" required name="aso_por_fon_retiro_sindical" id="aso_por_fon_retiro_sindical" type="text" size="2" maxlength="1" pattern="[4-8]+"/>%</td>
                    	<td colspan="2">&nbsp;</td>
                    </tr>
                    <tr>
                    <td colspan="2">Fecha de afiliaci&oacute;n</td><td colspan="2"><input type="text" name="aso_fec_afiliacion" id="aso_fec_afiliacion" required/>
                        <a href="javascript:NewCal('aso_fec_afiliacion','ddmmyyyy')"><img src="imagenes/cal.gif" width="16" height="16" border="0" alt="Pick a date" /></a></td>
                    </tr>
                    <tr>
                        <th colspan="4">
            ...
            <center>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        {
                            echo '<option value="'.$res_tip_seg_soc['tip_segSoc_id'].'">'.$res_tip_seg_soc['tip_segSoc_nombre']." - ".$res_tip_seg_soc['tip_segSoc_porcentaje']."%".'</option>';
                        }
                        ?>
                        </select></td>
                    </tr>
                    <tr>
                    	<td>Monto fijo</td><td colspan="3"><input type="checkbox" name="tipo_descuento_seg_social" id="tipo_descuento_seg_social" onchange="TipoSegSocial();" /></td>
                    </tr>
                    <tr id="monto_fijo" style="display:none;">
                    	<td>Valor $</td><td colspan="3"><input name="aso_mon_fij_seg_social" id="aso_mon_fij_seg_social" type="text" pattern="[0-9]+"/></td>
                   	</tr>
                    <tr>
                        <th colspan="4">
        ...
        <form id="frm_cre_afi_3" id="frm_cre_afi_3" method="post" onsubmit="recargarAso(5,this.id);return false;">
            ...
            ?>
                    ...
                    <tr>
                        ...
                        <td>Caja Compensaci&oacute;n</td>
                        ...
                        {
                            echo '<option value="'.$res_caj_compensacion['nit_id'].'">'.substr($res_caj_compensacion['nits_nombres'],0,50).'</option>';
                        }
                        ?>
                        </select></td>
                    </tr>
           ...
           <center>
             <div id="cont4" style="display:none">
                <table id="tabla">
                    ...
                    <tr id="beneficiarios">
                        <td><input type="text" name="aso_ape_beneficiario0" id="aso_ape_beneficiario0" pattern="[A-Z��a-z ]+" required/></td> 
                        <td><input type="text" name="aso_nom_beneficiario0" id="aso_nom_beneficiario0" pattern="[A-Z��a-z ]+" required/></td>

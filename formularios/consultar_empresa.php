...
<script src="librerias/ajax/select_deptos.js"></script>
<script type="text/javascript" src="librerias/js/jquery-1.5.0.js"></script>
<script>
...
@include_once('clases/nits.class.php');
$ins_nits = new nits();
$con_dat_proveedor=$ins_nits->ConDatProPorTipId(13,380);
...
$data_1=$ins_nits->con_ciu_dep_asociado(1,380);
$dat_dep_1=mssql_fetch_array($data_1);
$ciu_1 = $ins_nits->con_ciu_dep_asociado(1,380);
...
function genera_departamentos_1($dep_1)
{
	...
	echo "<select name='select1' id='select1' onChange='cargaContenido(this.id)' disabled='disabled' required x-moz-errormessage='Seleccione Una Opcion Valida'>";
...
?>
<form name="datos_proveedor" id="datos_proveedor" method="post" action="control/modifcar_proveedor.php?pro_id=380&tip=2">
<center>
  <table>
        <tr>
        ...
        <tr>
          ...
          <td>NIT</td><td><input type="text" name="pro_nit" id="pro_nit" onchange="verificacion(this.value)" size="9" value="<?php echo $par_nit[0]; ?>" disabled required/> - <input type="text" name="pro_dig_verificacion" id="pro_dig_verificacion" size="1" value="<?php echo $par_nit[1]; ?>" disabled required /></td>
         </tr>  
        <tr>
        ...
        ?>
           ...
           <tr>
              <td>Fax</td>
                ...
                <td>Banco</td>
                <td>
                  <select name="pro_banco" id="pro_banco" disabled required x-moz-errormessage="Seleccione Una Opcion Valida">
                    <option value="">--Seleccione--</option>
                    <?php
          ...
          ?> 
           ...
           <tr>
              <td>Tipo Cuenta</td>
                <td><select name="pro_tip_cuenta" id="pro_tip_cuenta" disabled required x-moz-errormessage="Seleccione Una Opcion Valida">
                  <option value="">--Seleccione--</option>
                    <?php
          ...
          ?>
                ...
                <td><input name="pro_num_cuenta" id="pro_num_cuenta" type="text" value="<?php echo $res_dat_proveedor['nits_num_cue_bancaria']; ?>" disabled required/></td>               
           </tr>
           <tr>
            <td colspan="4">

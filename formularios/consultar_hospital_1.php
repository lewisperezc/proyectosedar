...
$con_tip_nit = $instancia_nits->con_dat_nit(8);
?>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
    ...
    <tbody> 
		 ...
		 ?>
		<tr class="gradeA"> 
			<td><a href="consultar_hospital_2.php?hos_id=<?php echo $resul['nit_id']; ?>"><?php echo $resul['nombres']; ?></a></td>
			<td><a href="consultar_hospital_2.php?hos_id=<?php echo $resul['nit_id']; ?>"><?php echo $resul['nits_num_documento']; ?></a></td>
		</tr>
        <?php } ?>
	</tbody>		
</table>

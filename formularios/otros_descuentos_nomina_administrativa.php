...
function PreguntarEliminar(des_com_id)
{
    ...
    if(mensaje)
        location.href='../control/eliminar_otro_descuento_nomina_administrativa.php?des_com_id='+des_com_id;
}
</script>
</head>
<body>
...
$con_des_aplicados=$ins_com_nomina->ConsultarDescuentosNominaAdministrativa($datos[0],0,0,1);
    ...
    <table border="1" bordercolor="#0099CC">
        ...
        <tr>
            ...
            <?php
                    while($res_cue_nomina_1=mssql_fetch_array($con_cue_nomina_1))
                    {
                        if($res_cue_nomina_1['cue_id']==$res_des_aplicados['des_nom_adm_cuenta'])
            ...
            ?>
                    ...
                    <td><input type="text" name="des_apli_nom_valor0" id="des_apli_nom_valor0" required="required" value="<?php echo $res_des_aplicados['des_nom_adm_valor'] ?>"/></td>
                    <td><input type="radio" name="des_apli_nom_eliminar0" id="des_apli_nom_eliminar0" required="required" value="<?php echo $res_des_aplicados['des_nom_adm_id'] ?>" onclick="PreguntarEliminar(this.value)";/></td>
                </tr>
            <?php
            }
            ?>
...
<form method="post" name="des_nomina" id="des_nomina" action="../control/guardar_otro_descuento_nomina_administrativa.php">
    ...
    <table>
        <tr>
            ...
            <input type="hidden" name="des_nom_adm_nit" id="des_nom_adm_nit" value="<?php echo $datos[0]; ?>"/>
            <input type="hidden" name="des_nom_adm_causacion" id="des_nom_adm_causacion" value="0"/>
            <input type="hidden" name="des_nom_adm_pago" id="des_nom_adm_pago" value="0"/>

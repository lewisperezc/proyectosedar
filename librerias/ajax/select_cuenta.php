...
if(validaSelect($selectDestino) && validaOpcion($opcionSeleccionada))
{
    ...
    $sql = "SELECT * FROM cuentas WHERE cue_id =$opcionSeleccionada and cue_subdivision = 'si'";
...
{
	$tabla=$listadoSelects[$selectDestino];
    $sqln="SELECT * FROM cuentas WHERE cue_id like('$opcionSeleccionada%') and cue_subdivision ='si'";
	...
	{
		$registro['desc_total']=htmlentities($registro['desc_total']);
		echo "<option value = '".$registro['cue_id']."'>".$registro['cue_id']."--".$registro['cue_nombre']."</option>";

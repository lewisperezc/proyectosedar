	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": "VER _MENU_ PRIMEROS",
				"sZeroRecords": "NO SE ENCONTRARON RESULTAODOS RELACIONADOS",
				"sEmptyTable": "NO SE ENCONTRARON DATOS EN LA CONSULTA A LA BASE DE DATOS.",
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = oSettings.oLanguage.sSearch+sSpace+'<input type="text" placeholder="ESCRIBA AQUI EL CRITERIO DE BUSQUEDA..."/>';

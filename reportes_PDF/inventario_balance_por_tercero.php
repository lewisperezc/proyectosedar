...
$inv_desde=$_POST['inv_desde'];
$inv_hasta=$_POST['inv_hasta'];
...
{ 
//Logo 
$this->Image("../imagenes/reportes/inventario_balance_por_tercero.jpg",0,0,200,'C');
//Arial bold 15
...
$sql = "EXECUTE inv_bal_por_tercero $mes,'$inv_desde','$inv_hasta'";
...
if($query)
{
	...
	while($row = mssql_fetch_array($que_balance))
	{
	  if($row['tres']!=0 || $row['cinco']!=0)
	  {
			  ...
			  $pdf->SetY(65+($i*3));$pdf->SetX(93);$pdf->Cell(21,8,substr($row['dos'],0,25));
